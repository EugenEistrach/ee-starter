...
/*
  This file is adapted from next-themes to work with React applications.
...
const Theme = ({
  ...
  const applyTheme = React.useCallback(
    ...
    [attrs, attribute, value, enableColorScheme, defaultTheme, disableTransitionOnChange, enableSystem]
  )

  // Set theme state and save to local storage
  const setTheme = React.useCallback(
    (value: string | ((prevTheme: string | undefined) => string)) => {
  ...
  const providerValue = React.useMemo(
    () => ({
      ...
      systemTheme: getSystemTheme() as 'dark' | 'light' | undefined,
    }),
